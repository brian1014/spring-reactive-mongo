...
import guru.springframework.springreactivemongo.mappers.CustomerMapper;
import guru.springframework.springreactivemongo.model.CustomerDTO;
import guru.springframework.springreactivemongo.repositories.CustomerRepository;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public Mono<CustomerDTO> saveNewCustomer(Mono<CustomerDTO> customerDTO) {
        return customerDTO.map(customerMapper::dtoToEntity)
